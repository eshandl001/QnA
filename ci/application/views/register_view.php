...
<div class="btn">
  ...
  <button type="button"  class="btn btn-primary" id="top" href="#">Top Questions</button>&emsp;&emsp;&emsp;&emsp;
            ...
            <form action="/ci/index.php/auth/createaccount" method="POST" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-4">
                        <div class="input-group">
                            <span class="input-group-addon"><span class="glyphicon glyphicon-star"></span></span>
                            <input type="password" class="form-control" name='conf_pword' placeholder="Password">
                        </div>
                    </div>
                </div>
                <div class="form-group">
